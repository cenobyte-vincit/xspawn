#!/usr/bin/env bash
#
# t007-unknown-flag.sh - Unknown flag must print usage.
#
# Invokes oneshot with -z. Expects non-zero exit and stderr containing
# "usage:".
#
set -euo pipefail
IFS=$'\n\t'
...
main() {
	...
	err="$("${SPAWN_BIN}" oneshot -z -l com.example.flag -- \
